...
```{python id="F1op-CbyLuN4", colab={'base_uri': 'https://localhost:8080/'}, outputId="d8fae9ee-6f6d-4e6e-9e73-2e4d98f33292"}
...
```{python id="imGrKO5YH11-", colab={'base_uri': 'https://localhost:8080/'}, outputId="373bf1d0-9ad2-469a-caf5-ebed4f4743a3"}
...
```{python id="afXwPCA3KNoC", colab={'base_uri': 'https://localhost:8080/', 'height': 86}, outputId="cba35970-5387-4b29-e854-f3998c3bc1dd"}
import torch
...
```{python id="0YgHcLXMLk4o", colab={'base_uri': 'https://localhost:8080/', 'height': 300}, outputId="fb97a10f-ef69-4dce-a8b9-92fc6c133ec1"}
...
<!-- #region id="kG4IKy9YOLGF" -->
After training the model, we can call the `test` function to see how well our model performs on unseen labels.
Here, we are interested in the accuracy of the model, *i.e.*, the ratio of correctly classified nodes:
<!-- #endregion -->

```{python id="dBBCeLlAL0oL", colab={'base_uri': 'https://localhost:8080/', 'height': 34}, outputId="c2c3b385-ed56-4516-a3d7-5d0726021eda"}
test_acc = test()
print(f'Test Accuracy: {test_acc:.4f}')
```

<!-- #region id="_jjJOB-VO-cw" -->
...
```{python id="fmXWs1dKIzD8", colab={'base_uri': 'https://localhost:8080/', 'height': 86}, outputId="3646967f-a64c-4705-b9a6-2824ce2b7dc7"}
...
<!-- #region id="XhO8QDgYf_Q8" -->
Let's visualize the node embeddings of our **untrained** GCN network.
For visualization, we make use of [**TSNE**](https://scikit-learn.org/stable/modules/generated/sklearn.manifold.TSNE.html) to embed our 7-dimensional node embeddings onto a 2D plane.
<!-- #endregion -->

```{python id="ntt9qVFXlk6A", colab={'base_uri': 'https://localhost:8080/', 'height': 578}, outputId="84fa5748-16ce-4956-d5ff-a3606fd60eeb"}
model = GCN(hidden_channels=16)
model.eval()
...
```{python id="p3TAi69zI1bO", colab={'base_uri': 'https://localhost:8080/', 'height': 300}, outputId="9d8fd9c6-b769-451c-d0d9-bbd7640c5345"}
from IPython.display import Javascript  # Restrict height of output cell.
display(Javascript('''google.colab.output.setIframeHeight(0, true, {maxHeight: 300})'''))
...
<!-- #region id="opBBGQHqg5ZO" -->
After training the model, we can check its test accuracy:
<!-- #endregion -->

```{python id="8zOh6IIeI3Op", colab={'base_uri': 'https://localhost:8080/', 'height': 34}, outputId="56f61d61-8047-4a0e-eab8-0afb7817108b"}
test_acc = test()
print(f'Test Accuracy: {test_acc:.4f}')
```

<!-- #region id="yhofzjaqhfY2" -->
**There it is!**
...
```{python id="9r_VmGMukf5R", colab={'base_uri': 'https://localhost:8080/', 'height': 578}, outputId="2472df03-f965-4f97-876c-63782136eda9"}
model.eval()
