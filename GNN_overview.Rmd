...
```{python id="5rW4GtxOut7v", outputId="df2a15a0-7df0-4868-fa79-84f836f98965"}
## Standard libraries
import os
import json
import math
...
<!-- #region id="3c5prc7eut72" -->
## Graph Neural Networks
<!-- #endregion -->

<!-- #region id="zh2yc81put74" -->
...
```{python id="zBAS_aQOut7-", outputId="a76388e3-1702-451b-ad31-dde4877bae97"}
...
```{python id="BFUKqHlhut8A", outputId="88d73068-d38f-4101-ea11-504dfc6cf8ed"}
...
```{python id="Og0spjB0ut8E", outputId="f8f54449-bd58-485a-8b0e-318fd0416c05"}
...
```{python id="4S0E16Xyut8G", outputId="f03686d6-b5fe-4c5c-a265-b81f67fc03b9"}
# torch geometric
try: 
...
```{python id="6pqNfQk-ut8K"}
cora_dataset = torch_geometric.datasets.Planetoid(root=DATASET_PATH, name="Cora")
```

<!-- #region id="_2sRE-qtut8K" -->
...
```{python id="mT5CBM_jut8L", outputId="ad8b3d9d-6ce5-43b4-a44d-b0455d610212"}
cora_dataset[0]
```

<!-- #region id="Cpg8_WqBut8L" -->
...
```{python id="U3rt5jzbut8Q", outputId="49647937-8a26-4fe1-a50b-7b6c49c5a605"}
...
```{python id="aceas4bqut8R", outputId="6341753d-6605-4b84-faf1-5284fbddf445"}
...
```{python id="QeUiRlmvut8T"}
tu_dataset = torch_geometric.datasets.TUDataset(root=DATASET_PATH, name="MUTAG")
```

<!-- #region id="y2qSkZtyut8U" -->
Let's look at some statistics for the dataset:
<!-- #endregion -->

```{python id="vDpTXiCOut8U", outputId="685e8df7-135c-4a6b-ae48-a5e94353959d"}
print("Data object:", tu_dataset.data)
print("Length:", len(tu_dataset))
print("Average label: %4.2f" % (tu_dataset.data.y.float().mean().item()))
```

<!-- #region id="OPX-rAbwut8V" -->
...
```{python id="hpMu4jW8ut8W"}
graph_train_loader = geom_data.DataLoader(train_dataset, batch_size=64, shuffle=True)
graph_val_loader = geom_data.DataLoader(test_dataset, batch_size=64) # Additional loader if you want to change to a larger dataset
graph_test_loader = geom_data.DataLoader(test_dataset, batch_size=64)
```

<!-- #region id="v5l_F2lXut8X" -->
Let's load a batch below to see the batching in action:
<!-- #endregion -->

```{python id="MQWTfKwcut8X", outputId="63fa85d8-f202-430b-fae1-b00edcd93f7c"}
